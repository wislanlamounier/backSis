...
<div id="principal">
	...
	<div class='content_add_cliente' id="formulario">
		<form form method="POST" id="add_cliente" action="index.php" onsubmit="return valida(this)">
			<div id="dados_pessoa_juridica">
					<table id="table_dados_pes" border="0" style="width:100%">
					 <tr><td colspan="2" padding-top:='10px'> <h2>Dados Cadastrais</td></tr>
					 ...
					 <br><br></td></tr>
					 <tr> <td ><div id="razao_nome">Razão Social:</div></td><td><input type="text" id="nome" name="nome" style="width:100%;"></td></tr>
			         <tr> <td ><div id="data_fun_data_nasc">Data Fundação:</div></td> <td><input type="date" id="data_nasc" name="data_nasc" style="width:100%;"></td></tr>
			         <tr> <td ><div id="cnpj_cpf">CNPJ:</div></td><td><input type="text" id="cnpj" name="cnpj" style="width:100%;"><input type="hidden" id="cpf" name="cpf" style="width:100%;" ></td></tr> 
			         <tr> <td ><span>Celular:</span></td> <td><input type="text" id="cel" name="cel" style="width:100%;"></td></tr> 
			         <tr> <td ><span>Telefone:</span></td> <td><input type="text" id="tel" name="tel" style="width:100%;"></td></tr>			                    
			         <tr> <td ><div id="inscricao_estadual_rg">Inscrição Estadual:</div></td> <td><input type="number" id="inscricao_estadual" name="inscricao_estadual" style="width:100%;"> <input type="hidden" id="rg" name="rg" style="width:100%;" ></td></tr>			                     
			         <tr> <td ><div id="inscricao_municipal_nulo">Inscrição Municipal:</div></td> <td><input type="number" id="inscricao_municipal" name="inscricao_municipal" style="width:100%;"></td></tr></div>        
                     <tr><td colspan="2"><h2>Endereço</td></tr>
                     <tr> <td ><span>Bairro:</span></td> <td><input type="text" id="bairro" name="bairro" style="width:100%;"></td></tr> 
                     <tr> <td ><span>Rua:</span></td> <td><input type="text" id="rua" name="rua" style="width:100%;"></td></tr> 
                     <tr> <td ><span>Numero:</span></td> <td><input type="number" id="numero" name="numero" style="width:100%;"></td></tr>
                     ...
                     <tr> <td ><span>CEP:</span></td> <td><input type="number" id="cep" name="cep" style="width:100%;"></td></tr> 
                     <tr> <td ><span>Site:</span></td> <td><input type="text" id="site" name="site" style="width:100%;"></td></tr>
                     <tr><td colspan="2"><h2>Responsavel</td></tr>
                     <tr> <td ><span>Nome:</span></td> <td><input type="text" id="nome_resp" name="nome_resp" style="width:100%;"></td></tr> 
                     <tr> <td ><span>CPF:</span></td> <td><input type="text" id="cpf_resp" name="cpf_resp" style="width:100%;"></td></tr> 
                     <tr> <td ><span>Data Nascimento:</span></td> <td><input type="date" id="datanasc_resp" name="datanasc_resp" style="width:100%;"></td></tr> 
                     <tr> <td ><span>E-mail:</span></td> <td><input type="text" id="email_resp" name="email_resp" style="width:100%;"></td></tr>                     
                     <tr><td colspan="2"><h2>Observação</h2></td></tr>                     

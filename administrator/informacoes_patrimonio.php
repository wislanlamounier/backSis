...
<script type="text/javascript">
	function buscar_funcionarios(param){
        if(param == 0){//EDITAR
      	   var patrimonio = document.getElementById('nome_search').value;
            //se encontrou o estado
            if(patrimonio){
            	
              var url = '../ajax/ajax_buscar_informacoes_patrimonio.php?patrimonio='+patrimonio+'&param='+param;  //caminho do arquivo php que irá buscar as cidades no BD

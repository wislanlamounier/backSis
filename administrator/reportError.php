...
<div class='formulario' style="background-color:rgba(200,200,200,0.8); box-shadow: 5px 5px 10px #333; border: 5px solid#ababab; border-radius:5px;">
	...
	<form method="post" action='reportMailError.php' id="form_error" name="form_error">
		...
		<div class='form-input' style="text-align:left"><b>Descrição do erro</b></div><br /><textarea name='descricao' id='descricao' style="border-radius: 5px; width:100%; max-width:100%; height:100px; max-height:150px" placeholder="Descreva o erro encontrado..."></textarea>

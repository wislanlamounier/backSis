		...
		<div class='content' style="height:350px">
			...
			<form type="submit" method="POST" action="loggar.php"> 
				<table class="tabelapadrao" id="table_login" border="0" style="width:250px;">
					...
					<tr>
						<td><input id="btn_entrar" style="width:100px; margin: 0 auto;" class="form-control" name="btn_entrar" type="submit" value="Entrar"><div style="font-size:11px; margin-top:5px;"><a href="../#cadastro">Cadastre-se</a><br /><a href="../view/esqueci_minha_senha.php">Esqueci minha senha</a><div></td>
					</tr>
				</table>
			</form>
			<?php 

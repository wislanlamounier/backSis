...
<body onload="initMap(), exeMasc()">	
            ...
            <div class="formulario" style="width:43%;" id="form_obra">
              <div class="title-box" style="float:left;width:100%"><div style="float:left"><img src="../images/add.png" width="35px" style="margin-left:5px;"></div><div style="float:left; margin-top:10px; margin-left:10px;"><span class="title">EDITAR OBRA</span></div></div>
                              ...
                              <div class="bloco-1" id="dados_obra">            
                                  ...
                                  <div class="body-bloco">
                                      ...
                                      <?php 
                                                    ...
                                                    echo '<div style="text-align:center; padding: 10px">Atenção, você precisa selecionar pelo menos um produto para poder adicionar um cronograma<br /><a href="edita_obra?t=a_pr_o">Você pode adicionar um produto clicando aqui!</a>!</div>';
                                                }
                                          }else{// else inicio da obra
                                                echo '<div style="text-align:center; padding: 10px">Atenção, você precisa definir o início da obra para poder adicionar um cronograma<br /><a href="edita_obra?t=a_d_o">Você pode definir a data de início clicando aqui</a>!</div>';
         ...
         <div class="formulario" style="width:43%;">
            <div class="bloco-1">
                <div class="form-input">
                    <div class="form-input"><b>DADOS DA OBRA</b></div>

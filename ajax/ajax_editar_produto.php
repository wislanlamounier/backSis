			...
			<form>
				<div class="msg" style="float:left;">
					...
					<table style="float:left" class="table-pesquisa">
					  	<tr><td colspan="2"><span>Digite o nome do produto para editar:</span><br /></td></tr>
						<tr>
	...
	<?php }else if($_GET['param'] == 2){ ?>
			<form>
				<div class="msg" style="float:left;">
					...
					<table style="float:left" class="table-pesquisa">
					  	<tr><td colspan="2"><span>Digite o nome de um produto para excluir:</span><br /></td></tr>
						<tr>
							<td><span>Nome: </span></td>
	...
	<?php }else{ ?>
		<form>
			<div class="msg" style="float:left;">
				<div style="float:left; background-color:rgba(50,200,50,0.3); width:100%; height:43px; text-align:left; margin-top:-20px;">
					<div style="float:left; margin-left:5px;"><img src="../images/search-icon.png" style="width:40px;"></div>
					<div style="float:left; margin-left:5px; margin-top:10px; font-size:18px; color:#333;">Pesquisar Produto</div>
				</div>
				<table style="float:left" class="table-pesquisa">

			...
			<div class="msg" style="float:left;">
				...
				<table style="float:left" class="table-pesquisa">
					...
					<tr>
						...
						<td><input type="text" id="nome_search" name="nome_search"></td><td><input type="button" value="Buscar" onclick="buscar_funcionario(0)"></td>
					</tr>
		...
		<form>
				<div class="msg" style="float:left;">
					...
					<table style="float:left" class="table-pesquisa">
						...
						<tr>
							<td><span>Nome: </span></td>
							<td><input type="text" id="nome_search" name="nome_search"></td><td><input type="button" value="Buscar" class="button" onclick="buscar_funcionario(1)"></td>
						</tr>

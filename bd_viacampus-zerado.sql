...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Set-2015 às 19:55
...
ALTER TABLE `obra_materiais`
  ADD PRIMARY KEY (`id`), ADD KEY `FK_ID_OBRA` (`id_obra`), ADD KEY `FK_ID_MATERIAL` (`id_material`);
...
--
ALTER TABLE `veiculo`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `matricula` (`matricula`), ADD UNIQUE KEY `chassi` (`chassi`,`renavam`,`placa`);
...
--
ALTER TABLE `funcionario`
  MODIFY `id_tabela` int(11) NOT NULL AUTO_INCREMENT;
--

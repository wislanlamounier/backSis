...
--
-- Host: 127.0.0.1
-- Generation Time: 11-Dez-2015 às 21:02
...
(1, '15421-21', 'Programador de sistemas de informação', 0, 1),
(2, '0151-32', 'Programador de sistemas de informação', 0, 2),
(3, '15421-21', 'Programador de sistemas de informação', 0, 3),
(4, '0151-32', 'Programador de sistemas de informação', 0, 5),
(5, '0151-33', 'Administrador', 0, 3),
(6, '12151-23', 'Doador de Sangue', 0, 5),
(7, '0215-21', 'Perfurador de solo', 0, 5),
(8, '002', 'Engenheiro Civil', 0, 3),
(9, '00151-01', 'Programador de sistemas de informação', 0, 7);

-- --------------------------------------------------------

--
-- Estrutura da tabela `cbo_exames`
--
...
INSERT INTO `cbo_exames` (`id`, `id_cbo`, `id_exame`) VALUES
(1, 6, 1),
(2, 9, 1);
...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `telefone_cel` varchar(25) NOT NULL,
  `telefone_com` varchar(25) NOT NULL,
  ...
  `cpf_responsavel` varchar(25) NOT NULL,
...
(1, 'Fornecedor', '2015-09-23', '12.314.531/2313-21', '(13) 2123-1131', '(32) 1312-1321', 5, 1, '', '3213212313', '132131321', '1321313', '1321313131', '2015-09-02', 'dsfdsfdsafdsafdaf', '131313213132', '', 1, 4, 0),
(2, 'Curso Aprovação', '2015-09-23', '', '(95) 6445-4954', '(94) 5113-5135', 8, 1, '', '13515135153', '13513135151', 'Fernando', '512.412.154-11', '1983-02-24', 'fernando@cursoaprovacao.com.br', 'www.cursoaprovacao.com.br', '', 0, 5, 0),
(3, 'Cliente Juridico', '2015-09-23', '41.231.513/1513-51', '(41) 3531-2151', '(41) 3531-5153', 9, 1, '', '153151', '1351531351', 'Cliente', '412.394.698-45', '2015-09-02', 'fernando@cursoaprovacao.com.br', 'www.cliente.com.br', '', 1, 3, 0),
(4, 'Telefonia Movel LTDA', '2015-09-24', '54.124.512/5151-23', '(41) 9165-6251', '(41) 3531-2151', 12, 1, '', '15156151', '13515311', 'Alberto da Silva', '412.394.698-45', '1984-06-20', 'alberto@hotmail.com', 'www.tim.com.br', '', 0, 5, 0),
(5, 'Jose', '2015-09-16', '077.765.229-37', '(41) 9889-0957', '(41) 3265-3076', 15, 0, '11111309-2', '', '', 'Lucas Soares Nogueira', '077.765.229-37', '1994-01-15', '_lucasoares@outlook.com', '', 'BLABLABLABLABLA', 0, 3, 1),
(6, 'Empresa Teste', '2015-10-02', '15.616.516/5151-16', '(15) 6165-1651', '(16) 5165-1651', 17, 1, '', '', '', 'Jose', '814.949.494-94', '1019-01-08', 'email@email', 'site@site', 'xxxxxxxxxxxxxxxxxxxxxxxxx', 1, 3, 0),
(7, 'Pedro', '2015-10-06', '077.765.229-37', '(41) 9889-0957', '(41) 3265-3007', 20, 0, '1113092', '', '', 'jose', '077.765.229-37', '2015-10-08', 'email@email', 'site@site.com', 'xxyyyxyxyxyxyxyxyxyxy', 0, 3, 0);
...
CREATE TABLE IF NOT EXISTS `config` (
  `id` int(11) NOT NULL,
  `id_empresa` int(11) NOT NULL,
  `temp_limit_atraso` int(11) NOT NULL COMMENT 'limite de atraso permitido',
  `exibe_box_atrasos` int(11) NOT NULL COMMENT '0 oculta 1 exibe',
  `exibe_box_sem_registros` int(11) NOT NULL COMMENT '0 oculta 1 exibe',
  `percentual_custo_func` double NOT NULL COMMENT 'Percentual para saber o valor custo do funcionario',
  `caminho_logo` varchar(255) NOT NULL
...
INSERT INTO `config` (`id`, `id_empresa`, `temp_limit_atraso`, `exibe_box_atrasos`, `exibe_box_sem_registros`, `percentual_custo_func`, `caminho_logo`) VALUES
(1, 3, 10, 1, 1, 2.75, 'logo-sgo.png'),
(4, 8, 10, 1, 1, 2.75, 'logo.png');
...
INSERT INTO `contas` (`id`, `codigo`, `fornecedor_cliente`, `obra`, `banco`, `valor`, `multa`, `data_vencimento`, `parcelas`, `juros`, `oculto`, `descricao`, `tipo`, `status`, `id_empresa`, `periodo_juros`, `data_pagamento`) VALUES
(1, 'XX', '6', 'obrax', 'Bradesco', 500, 1, '2015-12-15', 2, '10', 0, 'Descrição testee', 1, 1, 3, 'ao dia', '0000-00-00'),
(2, 'Receber', '7', 'obray', 'Banco do brasil', 50000, 12, '2015-12-09', 30, '10', 0, 'xxxxxxx', 2, 0, 3, 'mes', '0000-00-00'),
(3, 'a pagar', '3', 'obray', 'fasd', 23.42, 2323323.23, '2015-12-01', 234234, '234324', 0, 'asdfasdf', 1, 1, 3, 'mes', '0000-00-00'),
(4, 'asdfasdf', '7', 'obrax', 'Bradesco', 2342.34, 10000, '2015-12-07', 54, '454', 0, '', 2, 0, 3, 'mes', '0000-00-00'),
(5, 'Codigoddxx', 'Sem fornecedor ou cliente', 'obray', 'xxx', 2342.34, 100, '2015-12-15', 20, '15', 0, '', 1, 1, 3, 'anual', '0000-00-00'),
(7, 'asfdasdf', '3', 'obrax', 'fasdfasf', 234.24, 2342.34, '2015-12-16', 23424, '234234', 0, '', 1, 0, 3, 'ao dia', '0000-00-00'),
(14, '234234', 'Sem fornecedor ou cliente', 'obrax', '234234', 234223.34, 2342.34, '2015-12-08', 2342, '234234', 0, '234234324', 1, 0, 3, 'anual', '0000-00-00'),
(27, 'asfdsdfasdfads', 'Sem fornecedor ou cliente', 'obray', 'asdfasdfasfd', 2342.34, 234234.23, '2015-12-09', 234234, '2%', 0, 'asdfasdfasdf', 1, 0, 3, 'anual', '0000-00-00');
...
--
-- Estrutura da tabela `custo_regiao`
--

CREATE TABLE IF NOT EXISTS `custo_regiao` (
  `id` int(11) NOT NULL,
  `id_regiao` int(11) NOT NULL,
  `id_valor_custo` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `custo_regiao`
--

INSERT INTO `custo_regiao` (`id`, `id_regiao`, `id_valor_custo`, `id_material`, `id_empresa`, `oculto`) VALUES
(1, 2, 146, 54, 3, 0),
(2, 2, 144, 60, 3, 0),
(3, 2, 149, 59, 3, 0),
(4, 2, 75, 61, 3, 0),
...
(2, '', '', '', ''),
(3, '', '', '', ''),
(4, 'CAIXA ECONOMICA FEDERAL', '1521', '023', '15624-5'),
(5, '', '', '', ''),
(6, '', '', '', ''),
(7, '', '', '', ''),
(8, '', '', '', ''),
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `ins_estadual` varchar(55) NOT NULL,
  `ins_municipal` varchar(55) NOT NULL,
...
INSERT INTO `empresa` (`id`, `razao_social`, `nome_fantasia`, `cnpj`, `ins_estadual`, `ins_municipal`, `id_endereco`, `telefone`, `id_responsavel`, `oculto`, `nivel_acesso`, `id_empresa`) VALUES
(1, 'Desenvolvimento de Softwares  LTDA', 'ControlSystem', '41.253.251/4521-54', '', '', NULL, '', 2, 0, 0, 1),
(2, 'Consertos de Computador LTDA', 'HomeConst', '45.123.512/1545-11', '', '', NULL, '', 2, 0, 0, 2),
(3, 'Construções de Casa LTDA', 'HomeConst', '51.556.456/1465-15', '20006563', '9996532115', 4, '(41) 3531-2135', 1, 0, 0, 3),
(4, 'Consertos de Computador LTDA', 'HomeConst', '41.239.469/8452-52', '', '', NULL, '', 3, 0, 0, 4),
(5, 'Desenvolvimento de Softwares  LTDA', 'ControlSystem', '41.251.451/6551-21', '35215142151', '151231541', 7, '(41) 3531-2654', 3, 0, 0, 5),
(6, 'xxx', '2343', '65.465.465/4654-64', '65465465465', '6546464', 13, '(41) 3265-6565', 6, 0, 0, 6),
(7, 'Sistema de ponto eletrônico', 'Ponto eletronico', '15.123.156/1561-61', '', '', 27, '(41) 3531-2121', 9, 0, 0, 7),
(8, 'Teste de empresa nova', 'Teste de empresa', '15.135.151/3535-13', '', '', NULL, '', 3, 0, 0, 8);
...
INSERT INTO `endereco` (`id`, `rua`, `numero`, `id_cidade`, `bairro`, `cep`, `complemento`) VALUES
(1, 'Rua teste', 152, 2878, 'Centro', '18460-000', ''),
(2, 'Rua teste', 152, 2878, 'Centro', '18460-000', ''),
(3, 'teste', 12, 2878, 'centro', '18460-000', 'casa'),
(4, 'Rua teste', 123512, 2878, 'Bairro', '81818-181', '2° andar'),
(5, '132132132132', 2147483647, 80, '23131132', '132132132132', ''),
(6, 'Waldemiro Ry', 193, 2878, 'Novo Mundo', '18460-000', ''),
(7, 'Simão Bolivar', 1521, 2878, 'Bacacheri', '18456-002', ''),
(8, 'Tibagi', 35216, 2878, 'Centro', '16520-000', ''),
(9, 'Rua', 6521, 2878, 'Centro', '18460-000', ''),
(10, 'Angelo dos santos', 370, 2878, 'Jardim das Americas', '18450-000', ''),
(11, 'São Pedro', 370, 2878, 'Jardim das Americas', '18450-000', ''),
(12, 'XV de Novembro', 5124, 2878, 'Centro', '', ''),
(13, 'xxx', 123, 2878, 'bairro', '81848-484', ''),
(14, 'safasfasfsdf', 275, 2832, 'campo de santana', '81490460', ''),
(15, 'neusa gusso', 275, 2878, 'campo de santana', '81490460', ''),
(16, 'Rua', 123, 2878, 'Bairro', '81457-555', ''),
(17, 'Rua', 4, 2878, 'Bairro', '81490460', '2° andar'),
(18, 'rua', 123, 80, 'bairro', '81490460', ''),
(19, 'rua', 123, 80, 'bairro', '81490460', 'Apartamento'),
(20, 'Rua', 123, 2877, 'Centro', '81490460', 'Casa'),
(21, 'rua', 123, 2878, 'centro', '81490460', 'Casa'),
(22, 'Rua', 123, 3608, 'campo de santana', '81490460', 'Casa'),
(23, 'Rua', 123, 3608, 'campo de santana', '81490460', ''),
(24, 'Rua', 123, 3608, 'campo de santana', '81490460', ''),
(25, 'Rua', 123, 3608, 'campo de santana', '81490460', ''),
(26, 'Angelo dos santos', 370, 2878, 'Centro', '18460-000', 'Casa'),
(27, 'Rua teste', 2120, 2878, 'Centro', '18460-000', ''),
(28, 'teste', 151, 1487, 'centor', '184600000', 'casa'),
(29, 'teste', 193, 1581, 'Centro', '', 'Casa');
...
INSERT INTO `equipamentos_func` (`id`, `codigo`, `nome_epi`, `descricao`, `id_empresa`, `quantidade`, `epi`, `oculto`) VALUES
(1, 'S-001', 'Segurança', 'Equipamento de segurança', 3, 25, 1, 0),
(2, 'U-001', 'Uniforme', 'Uniforme de coleta', 3, 25, 0, 0);
...
(1, 'Empresa Teste', 'F-001', '(41) 3256-8558', 16, 1, 3, 0),
(2, 'nome', 'codigo posto', '(33) 333-3333', 21, 1, 3, 0);
...
CREATE TABLE IF NOT EXISTS `funcionario` (
  ...
  `org_em_rg` varchar(255) NOT NULL,
  `data_em_rg` date NOT NULL,
  `num_tit_eleitor` varchar(30) NOT NULL,
  ...
  `id_valor_custo` int(11) NOT NULL,
  `qtd_horas_sem` int(11) NOT NULL,
  `num_cart_trab` varchar(50) NOT NULL,
  `num_serie_cart_trab` varchar(50) NOT NULL,
  `id_uf_cart_trab` int(11) NOT NULL COMMENT 'id do estado',
  `num_pis` varchar(20) NOT NULL,
  `data_ini` datetime NOT NULL COMMENT 'data inicio da validade do registro',
  `data_fim` datetime NOT NULL COMMENT 'data fim da validade do registro',
  `oculto` int(11) NOT NULL,
  `estagiario` int(11) NOT NULL
...
INSERT INTO `funcionario` (`id_tabela`, `cod_serie`, `id`, `nome`, `cpf`, `rg`, `org_em_rg`, `data_em_rg`, `num_tit_eleitor`, `data_nasc`, `telefone`, `email`, `email_empresa`, `senha`, `is_admin`, `id_cbo`, `id_endereco`, `id_turno`, `id_empresa`, `id_empresa_filial`, `id_supervisor`, `id_dados_bancarios`, `data_adm`, `data_dem`, `salario_base`, `id_valor_custo`, `qtd_horas_sem`, `num_cart_trab`, `num_serie_cart_trab`, `id_uf_cart_trab`, `num_pis`, `data_ini`, `data_fim`, `oculto`, `estagiario`) VALUES
(12, '0151-32', 1, 'Andre Matos', '412.394.698-45', '', '', '0000-00-00', '', '2015-09-01', '(41) 3531-2645', 'andre_matos13@hotmail.com', 'andre@controlsystem.com.br', '202cb962ac59075b964b07152d234b70', 1, 3, 3, 13, 3, 0, 0, 3, '2015-09-01', '0000-00-00', 1500, 29, 44, '', '', 0, '', '2015-09-23 15:18:20', '2015-10-31 23:59:00', 1, 0),
(85, 'func005', 2, 'Teste novo', '412.394.698-45', '', '', '2015-10-07', '', '2015-10-06', '(41) 3512-3135', 'andre_matos13@hotmail.com', 'andre@controlsystem.com.br', '202cb962ac59075b964b07152d234b70', 1, 5, 29, 13, 3, 0, 0, 16, '2015-10-06', '0000-00-00', 3000, 45, 44, '', '', 0, '', '2015-10-27 12:20:23', '2015-10-31 23:59:00', 1, 0),
(87, '0151-32', 1, 'Andre Matos', '412.394.698-45', '', '', '0000-00-00', '', '2015-09-01', '(41) 3531-2645', 'andre_matos13@hotmail.com', 'andre@controlsystem.com.br', '202cb962ac59075b964b07152d234b70', 1, 3, 3, 13, 3, 0, 0, 3, '2015-09-01', '0000-00-00', 1500, 29, 44, '', '', 0, '', '2015-11-01 00:00:00', '2015-11-30 23:59:00', 1, 0),
(89, 'func005', 2, 'Teste novo', '412.394.698-45', '', '', '2015-10-07', '', '2015-10-06', '(41) 3512-3135', 'andre_matos13@hotmail.com', 'andre@controlsystem.com.br', '202cb962ac59075b964b07152d234b70', 1, 5, 29, 13, 3, 0, 0, 16, '2015-10-06', '0000-00-00', 3000, 48, 44, '', '', 0, '', '2015-11-01 00:00:00', '0000-00-00 00:00:00', 0, 0),
(90, '0151-32', 1, 'Andre Matos', '412.394.698-45', '', '', '1993-01-08', '', '2015-09-01', '(41) 3531-2645', 'andre_matos13@hotmail.com', 'andre@controlsystem.com.br', '202cb962ac59075b964b07152d234b70', 1, 3, 3, 13, 3, 0, 0, 3, '2015-09-01', '0000-00-00', 1500, 29, 44, '', '', 0, '', '2015-12-01 00:00:00', '0000-00-00 00:00:00', 0, 0);
...
CREATE TABLE IF NOT EXISTS `horarios` (
  ...
  `observacao_funcionario` text NOT NULL,
...
INSERT INTO `horarios` (`id`, `hora`, `data`, `tipo`, `id_funcionario`, `id_obs_supervisor`, `observacao_funcionario`, `situacao`) VALUES
(1, '08:50:00', '2015-10-19', 1, 3, 13, '', '+0h20m'),
(2, '09:12:10', '2015-10-20', 1, 1, 15, 'Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema\nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema\nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema \nTestando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema Testando sistema ', '+1h12m'),
(3, '12:11:00', '2015-10-20', 2, 1, 14, '', '+0h11m'),
(4, '13:15:00', '2015-10-20', 3, 1, 0, '', '+0h15m'),
(5, '09:02:08', '2015-10-21', 1, 1, 0, 'Testando integração do sistema de ponto e sistema de gestão de obras, teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste teste', '+1h2m'),
(6, '09:37:40', '2015-10-22', 1, 1, 0, 'Iniciando atrasado', '+1h38m'),
(7, '12:12:00', '2015-10-23', 2, 1, 17, '', '+0h12m'),
(8, '08:10:00', '2015-11-12', 1, 1, 18, '', '+0h10m');

-- --------------------------------------------------------

--
-- Estrutura da tabela `horarios_registrados`
--

CREATE TABLE IF NOT EXISTS `horarios_registrados` (
  `id` int(11) NOT NULL,
  `data` date NOT NULL,
  `id_funcionario` int(11) NOT NULL,
  `tipo_1` tinyint(1) NOT NULL,
  `tipo_2` tinyint(1) NOT NULL,
  `tipo_3` tinyint(1) NOT NULL,
  `tipo_0` tinyint(1) NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=775 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `horarios_registrados`
--

INSERT INTO `horarios_registrados` (`id`, `data`, `id_funcionario`, `tipo_1`, `tipo_2`, `tipo_3`, `tipo_0`) VALUES
(11, '2015-10-01', 80, 1, 1, 1, 0),
(10, '2015-10-01', 82, 1, 1, 1, 1),
(12, '2015-10-01', 18, 1, 1, 1, 0),
(13, '2015-10-01', 81, 0, 1, 0, 0),
(360, '2015-10-06', 83, 1, 0, 0, 0),
(359, '2015-10-05', 83, 1, 0, 0, 1),
(358, '2015-10-04', 83, 0, 0, 0, 0),
(357, '2015-10-03', 83, 0, 0, 0, 0),
(356, '2015-10-02', 83, 1, 0, 0, 1),
(493, '2015-10-19', 82, 0, 0, 0, 0),
(492, '2015-10-19', 18, 0, 0, 0, 0),
(491, '2015-10-19', 80, 0, 0, 0, 0),
(490, '2015-10-19', 81, 0, 0, 0, 0),
(489, '2015-10-19', 83, 0, 0, 0, 0),
(488, '2015-10-19', 43, 0, 0, 0, 0),
(487, '2015-10-18', 82, 0, 0, 0, 0),
(486, '2015-10-18', 18, 0, 0, 0, 0),
(485, '2015-10-18', 80, 0, 0, 0, 0),
(484, '2015-10-18', 81, 0, 0, 0, 0),
(483, '2015-10-18', 83, 0, 0, 0, 0),
(482, '2015-10-18', 43, 0, 0, 0, 0),
(481, '2015-10-17', 18, 0, 0, 0, 0),
(480, '2015-10-17', 80, 0, 0, 0, 0),
(479, '2015-10-17', 81, 0, 0, 0, 0),
(478, '2015-10-17', 82, 0, 0, 0, 0),
(477, '2015-10-17', 83, 0, 0, 0, 0),
(476, '2015-10-17', 43, 0, 0, 0, 0),
(475, '2015-10-16', 85, 0, 0, 0, 0),
(474, '2015-10-15', 85, 0, 0, 0, 0),
(473, '2015-10-14', 85, 0, 0, 0, 0),
(472, '2015-10-13', 85, 0, 0, 0, 0),
(471, '2015-10-12', 85, 0, 0, 0, 0),
(470, '2015-10-11', 85, 0, 0, 0, 0),
(469, '2015-10-10', 85, 0, 0, 0, 0),
(468, '2015-10-09', 85, 0, 0, 0, 0),
(467, '2015-10-08', 85, 0, 0, 0, 0),
(466, '2015-10-07', 85, 0, 0, 0, 0),
(465, '2015-10-06', 85, 0, 0, 0, 0),
(459, '2015-10-16', 43, 0, 0, 0, 0),
(460, '2015-10-16', 83, 0, 0, 0, 0),
(461, '2015-10-16', 82, 0, 0, 0, 0),
(458, '2015-10-16', 18, 1, 1, 1, 1),
(464, '2015-10-16', 84, 0, 0, 0, 0),
(462, '2015-10-16', 81, 0, 0, 0, 0),
(463, '2015-10-16', 80, 0, 0, 0, 0),
(443, '2015-10-15', 84, 0, 0, 0, 0),
(442, '2015-10-15', 80, 0, 0, 0, 0),
(441, '2015-10-15', 81, 0, 0, 0, 0),
(440, '2015-10-15', 82, 0, 0, 0, 0),
(439, '2015-10-15', 83, 0, 0, 0, 0),
(438, '2015-10-15', 43, 0, 0, 0, 0),
(437, '2015-10-15', 18, 0, 0, 0, 0),
(436, '2015-10-14', 84, 0, 0, 0, 0),
(435, '2015-10-14', 80, 0, 0, 0, 0),
(434, '2015-10-14', 81, 0, 0, 0, 0),
(433, '2015-10-14', 82, 0, 0, 0, 0),
(432, '2015-10-14', 83, 0, 0, 0, 0),
(431, '2015-10-14', 43, 0, 0, 0, 0),
(430, '2015-10-14', 18, 0, 0, 1, 0),
(429, '2015-10-13', 84, 0, 0, 0, 0),
(428, '2015-10-13', 80, 1, 0, 1, 1),
(427, '2015-10-13', 81, 1, 1, 0, 0),
(426, '2015-10-13', 82, 1, 0, 0, 0),
(425, '2015-10-13', 83, 1, 0, 0, 0),
(424, '2015-10-13', 43, 1, 0, 0, 0),
(423, '2015-10-13', 18, 1, 1, 1, 1),
(422, '2015-10-12', 84, 0, 0, 0, 0),
(421, '2015-10-12', 80, 0, 0, 0, 0),
(235, '2015-10-08', 80, 1, 1, 1, 0),
(234, '2015-10-08', 81, 0, 0, 0, 0),
(233, '2015-10-08', 82, 1, 0, 1, 1),
(232, '2015-10-08', 43, 0, 0, 0, 0),
(231, '2015-10-08', 18, 1, 1, 1, 1),
(230, '2015-10-07', 80, 1, 1, 1, 1),
(229, '2015-10-07', 81, 1, 0, 0, 0),
(228, '2015-10-07', 82, 1, 1, 1, 1),
(227, '2015-10-07', 43, 0, 0, 0, 0),
(226, '2015-10-07', 18, 1, 1, 1, 1),
(225, '2015-10-06', 80, 1, 1, 1, 1),
(224, '2015-10-06', 81, 0, 0, 1, 0),
(223, '2015-10-06', 82, 1, 1, 1, 1),
(222, '2015-10-06', 43, 0, 0, 0, 0),
(221, '2015-10-06', 18, 1, 1, 1, 1),
(220, '2015-10-05', 80, 1, 1, 1, 1),
(219, '2015-10-05', 81, 1, 1, 1, 1),
(218, '2015-10-05', 82, 1, 1, 1, 0),
(217, '2015-10-05', 43, 1, 1, 1, 0),
(216, '2015-10-05', 18, 1, 1, 1, 1),
(215, '2015-10-04', 80, 0, 0, 0, 0),
(214, '2015-10-04', 81, 0, 0, 0, 0),
(213, '2015-10-04', 82, 0, 0, 0, 0),
(212, '2015-10-04', 43, 0, 0, 0, 0),
(211, '2015-10-04', 18, 0, 0, 0, 0),
(210, '2015-10-03', 80, 0, 0, 0, 0),
(209, '2015-10-03', 81, 0, 0, 0, 0),
(208, '2015-10-03', 82, 0, 0, 0, 0),
(207, '2015-10-03', 43, 0, 0, 0, 0),
(206, '2015-10-03', 18, 0, 0, 0, 0),
(389, '2015-10-02', 80, 1, 1, 1, 0),
(204, '2015-10-02', 81, 1, 1, 0, 1),
(203, '2015-10-02', 82, 1, 0, 0, 0),
(202, '2015-10-02', 43, 0, 0, 1, 0),
(201, '2015-10-02', 18, 1, 1, 1, 1),
(361, '2015-10-07', 83, 0, 0, 0, 0),
(362, '2015-10-08', 83, 0, 0, 0, 0),
(420, '2015-10-12', 81, 0, 0, 0, 0),
(419, '2015-10-12', 82, 0, 0, 0, 0),
(418, '2015-10-12', 83, 0, 0, 0, 0),
(417, '2015-10-12', 43, 0, 0, 0, 0),
(416, '2015-10-12', 18, 0, 0, 0, 0),
(415, '2015-10-11', 84, 0, 0, 0, 0),
(414, '2015-10-11', 80, 0, 0, 0, 0),
(413, '2015-10-11', 81, 0, 0, 0, 0),
(412, '2015-10-11', 82, 0, 0, 0, 0),
(411, '2015-10-11', 83, 0, 0, 0, 0),
(410, '2015-10-11', 43, 0, 0, 0, 0),
(409, '2015-10-11', 18, 0, 0, 0, 0),
(408, '2015-10-10', 84, 0, 0, 0, 0),
(407, '2015-10-10', 80, 0, 0, 0, 0),
(406, '2015-10-10', 81, 0, 0, 0, 0),
(405, '2015-10-10', 82, 0, 0, 0, 0),
(404, '2015-10-10', 83, 0, 0, 0, 0),
(403, '2015-10-10', 43, 0, 0, 0, 0),
(402, '2015-10-10', 18, 0, 0, 0, 0),
(401, '2015-10-09', 84, 0, 0, 0, 0),
(400, '2015-10-09', 80, 1, 1, 1, 0),
(399, '2015-10-09', 81, 1, 1, 1, 0),
(398, '2015-10-09', 82, 1, 0, 0, 0),
(397, '2015-10-09', 83, 0, 0, 0, 0),
(387, '2015-10-01', 43, 1, 1, 1, 0),
(388, '2015-10-01', 83, 1, 0, 0, 1),
(390, '2015-10-06', 84, 0, 0, 0, 0),
(391, '2015-10-07', 84, 0, 0, 0, 0),
(392, '2015-10-08', 84, 0, 0, 0, 0),
(396, '2015-10-09', 43, 0, 0, 0, 0),
(395, '2015-10-09', 18, 1, 1, 1, 1),
(494, '2015-10-20', 43, 0, 0, 0, 0),
(495, '2015-10-20', 83, 0, 0, 0, 0),
(496, '2015-10-20', 81, 0, 0, 0, 0),
(497, '2015-10-20', 80, 0, 0, 0, 0),
(498, '2015-10-20', 18, 0, 0, 0, 0),
(499, '2015-10-20', 82, 0, 0, 0, 0),
(500, '2015-10-21', 43, 0, 0, 0, 0),
(501, '2015-10-21', 83, 0, 0, 0, 0),
(502, '2015-10-21', 81, 0, 0, 0, 0),
(503, '2015-10-21', 80, 0, 0, 0, 0),
(504, '2015-10-21', 18, 0, 0, 0, 0),
(505, '2015-10-21', 82, 0, 0, 0, 0),
(506, '2015-10-22', 43, 0, 0, 0, 0),
(507, '2015-10-22', 83, 0, 0, 0, 0),
(508, '2015-10-22', 81, 0, 0, 0, 0),
(509, '2015-10-22', 80, 0, 0, 0, 0),
(510, '2015-10-22', 18, 0, 0, 0, 0),
(511, '2015-10-22', 82, 0, 0, 0, 0),
(512, '2015-10-23', 43, 0, 0, 0, 0),
(513, '2015-10-23', 83, 0, 0, 0, 0),
(514, '2015-10-23', 81, 0, 0, 0, 0),
(515, '2015-10-23', 80, 0, 0, 0, 0),
(516, '2015-10-23', 18, 0, 0, 0, 0),
(517, '2015-10-23', 82, 0, 0, 0, 0),
(518, '2015-10-24', 43, 0, 0, 0, 0),
(519, '2015-10-24', 83, 0, 0, 0, 0),
(520, '2015-10-24', 81, 0, 0, 0, 0),
(521, '2015-10-24', 80, 0, 0, 0, 0),
(522, '2015-10-24', 18, 0, 0, 0, 0),
(523, '2015-10-24', 82, 0, 0, 0, 0),
(524, '2015-10-25', 43, 0, 0, 0, 0),
(525, '2015-10-25', 83, 0, 0, 0, 0),
(526, '2015-10-25', 81, 0, 0, 0, 0),
(527, '2015-10-25', 80, 0, 0, 0, 0),
(528, '2015-10-25', 18, 0, 0, 0, 0),
(529, '2015-10-25', 82, 0, 0, 0, 0),
(530, '2015-10-26', 43, 0, 0, 0, 0),
(531, '2015-10-26', 83, 0, 0, 0, 0),
(532, '2015-10-26', 81, 0, 0, 0, 0),
(533, '2015-10-26', 80, 0, 0, 0, 0),
(534, '2015-10-26', 18, 0, 0, 0, 0),
(535, '2015-10-26', 82, 0, 0, 0, 0),
(536, '2015-10-27', 43, 0, 0, 0, 0),
(537, '2015-10-27', 83, 0, 0, 0, 0),
(538, '2015-10-27', 81, 0, 0, 0, 0),
(539, '2015-10-27', 80, 0, 0, 0, 0),
(540, '2015-10-27', 18, 0, 0, 0, 0),
(541, '2015-10-27', 82, 0, 0, 0, 0),
(542, '2015-10-28', 43, 0, 0, 0, 0),
(543, '2015-10-28', 83, 0, 0, 0, 0),
(544, '2015-10-28', 81, 0, 0, 0, 0),
(545, '2015-10-28', 80, 0, 0, 0, 0),
(546, '2015-10-28', 18, 0, 0, 0, 0),
(547, '2015-10-28', 82, 0, 0, 0, 0),
(548, '2015-10-29', 43, 0, 0, 0, 0),
(549, '2015-10-29', 83, 0, 0, 0, 0),
(550, '2015-10-29', 81, 0, 0, 0, 0),
(551, '2015-10-29', 80, 0, 0, 0, 0),
(552, '2015-10-29', 18, 0, 0, 0, 0),
(553, '2015-10-29', 82, 0, 0, 0, 0),
(554, '2015-10-19', 2, 0, 0, 0, 0),
(555, '2015-10-19', 3, 1, 0, 0, 0),
(556, '2015-10-19', 4, 0, 0, 0, 0),
(557, '2015-10-19', 5, 0, 0, 0, 0),
(558, '2015-10-19', 6, 0, 0, 0, 0),
(559, '2015-10-19', 7, 0, 0, 0, 0),
(560, '2015-10-19', 8, 0, 0, 0, 0),
(561, '2015-10-19', 1, 0, 0, 0, 0),
(562, '2015-10-19', 9, 0, 0, 0, 0),
(563, '2015-10-20', 2, 0, 0, 0, 0),
(564, '2015-10-20', 3, 0, 0, 0, 0),
(565, '2015-10-20', 4, 0, 0, 0, 0),
(566, '2015-10-20', 5, 0, 0, 0, 0),
(567, '2015-10-20', 6, 0, 0, 0, 0),
(568, '2015-10-20', 7, 0, 0, 0, 0),
(569, '2015-10-20', 8, 0, 0, 0, 0),
(570, '2015-10-20', 1, 1, 1, 1, 0),
(571, '2015-10-20', 9, 0, 0, 0, 0),
(572, '2015-10-21', 2, 0, 0, 0, 0),
(573, '2015-10-21', 3, 0, 0, 0, 0),
(574, '2015-10-21', 4, 0, 0, 0, 0),
(575, '2015-10-21', 5, 0, 0, 0, 0),
(576, '2015-10-21', 6, 0, 0, 0, 0),
(577, '2015-10-21', 7, 0, 0, 0, 0),
(578, '2015-10-21', 8, 0, 0, 0, 0),
(579, '2015-10-21', 1, 1, 0, 0, 0),
(580, '2015-10-21', 9, 0, 0, 0, 0),
(581, '2015-10-22', 2, 0, 0, 0, 0),
(582, '2015-10-22', 3, 0, 0, 0, 0),
(583, '2015-10-22', 4, 0, 0, 0, 0),
(584, '2015-10-22', 5, 0, 0, 0, 0),
(585, '2015-10-22', 6, 0, 0, 0, 0),
(586, '2015-10-22', 7, 0, 0, 0, 0),
(587, '2015-10-22', 8, 0, 0, 0, 0),
(588, '2015-10-22', 1, 1, 0, 0, 0),
(589, '2015-10-22', 9, 0, 0, 0, 0),
(590, '2015-10-23', 2, 0, 0, 0, 0),
(591, '2015-10-23', 3, 0, 0, 0, 0),
(592, '2015-10-23', 4, 0, 0, 0, 0),
(593, '2015-10-23', 5, 0, 0, 0, 0),
(594, '2015-10-23', 6, 0, 0, 0, 0),
(595, '2015-10-23', 7, 0, 0, 0, 0),
(596, '2015-10-23', 8, 0, 0, 0, 0),
(597, '2015-10-23', 1, 0, 1, 0, 0),
(598, '2015-10-23', 9, 0, 0, 0, 0),
(599, '2015-10-24', 2, 0, 0, 0, 0),
(600, '2015-10-24', 3, 0, 0, 0, 0),
(601, '2015-10-24', 4, 0, 0, 0, 0),
(602, '2015-10-24', 5, 0, 0, 0, 0),
(603, '2015-10-24', 6, 0, 0, 0, 0),
(604, '2015-10-24', 7, 0, 0, 0, 0),
(605, '2015-10-24', 8, 0, 0, 0, 0),
(606, '2015-10-24', 1, 0, 0, 0, 0),
(607, '2015-10-24', 9, 0, 0, 0, 0),
(608, '2015-10-25', 2, 0, 0, 0, 0),
(609, '2015-10-25', 3, 0, 0, 0, 0),
(610, '2015-10-25', 4, 0, 0, 0, 0),
(611, '2015-10-25', 5, 0, 0, 0, 0),
(612, '2015-10-25', 6, 0, 0, 0, 0),
(613, '2015-10-25', 7, 0, 0, 0, 0),
(614, '2015-10-25', 8, 0, 0, 0, 0),
(615, '2015-10-25', 1, 0, 0, 0, 0),
(616, '2015-10-25', 9, 0, 0, 0, 0),
(617, '2015-10-26', 2, 0, 0, 0, 0),
(618, '2015-10-26', 3, 0, 0, 0, 0),
(619, '2015-10-26', 4, 0, 0, 0, 0),
(620, '2015-10-26', 5, 0, 0, 0, 0),
(621, '2015-10-26', 6, 0, 0, 0, 0),
(622, '2015-10-26', 7, 0, 0, 0, 0),
(623, '2015-10-26', 8, 0, 0, 0, 0),
(624, '2015-10-26', 1, 0, 0, 0, 0),
(625, '2015-10-26', 9, 0, 0, 0, 0),
(626, '2015-10-27', 2, 0, 0, 0, 0),
(627, '2015-10-27', 3, 0, 0, 0, 0),
(628, '2015-10-27', 4, 0, 0, 0, 0),
(629, '2015-10-27', 5, 0, 0, 0, 0),
(630, '2015-10-27', 6, 0, 0, 0, 0),
(631, '2015-10-27', 7, 0, 0, 0, 0),
(632, '2015-10-27', 8, 0, 0, 0, 0),
(633, '2015-10-27', 1, 0, 0, 0, 0),
(634, '2015-10-27', 9, 0, 0, 0, 0),
(635, '2015-10-28', 2, 0, 0, 0, 0),
(636, '2015-10-28', 3, 0, 0, 0, 0),
(637, '2015-10-28', 4, 0, 0, 0, 0),
(638, '2015-10-28', 5, 0, 0, 0, 0),
(639, '2015-10-28', 6, 0, 0, 0, 0),
(640, '2015-10-28', 7, 0, 0, 0, 0),
(641, '2015-10-28', 8, 0, 0, 0, 0),
(642, '2015-10-28', 1, 0, 0, 0, 0),
(643, '2015-10-28', 9, 0, 0, 0, 0),
(644, '2015-10-29', 2, 0, 0, 0, 0),
(645, '2015-10-29', 3, 0, 0, 0, 0),
(646, '2015-10-29', 4, 0, 0, 0, 0),
(647, '2015-10-29', 5, 0, 0, 0, 0),
(648, '2015-10-29', 6, 0, 0, 0, 0),
(649, '2015-10-29', 7, 0, 0, 0, 0),
(650, '2015-10-29', 8, 0, 0, 0, 0),
(651, '2015-10-29', 1, 0, 0, 0, 0),
(652, '2015-10-29', 9, 0, 0, 0, 0),
(653, '2015-10-30', 3, 0, 0, 0, 0),
(654, '2015-10-30', 4, 0, 0, 0, 0),
(655, '2015-10-30', 5, 0, 0, 0, 0),
(656, '2015-10-30', 6, 0, 0, 0, 0),
(657, '2015-10-30', 7, 0, 0, 0, 0),
(658, '2015-10-30', 8, 0, 0, 0, 0),
(659, '2015-10-30', 9, 0, 0, 0, 0),
(660, '2015-10-30', 1, 0, 0, 0, 0),
(661, '2015-10-31', 1, 0, 0, 0, 0),
(662, '2015-10-30', 2, 0, 0, 0, 0),
(663, '2015-10-31', 2, 0, 0, 0, 0),
(664, '2015-11-01', 1, 0, 0, 0, 0),
(665, '2015-11-01', 2, 0, 0, 0, 0),
(666, '2015-11-03', 1, 0, 0, 0, 0),
(667, '2015-11-03', 1, 0, 0, 0, 0),
(668, '2015-11-03', 2, 0, 0, 0, 0),
(669, '2015-11-04', 1, 0, 0, 0, 0),
(670, '2015-11-04', 2, 0, 0, 0, 0),
(671, '2015-11-05', 1, 0, 0, 0, 0),
(672, '2015-11-05', 2, 0, 0, 0, 0),
(673, '2015-11-06', 1, 0, 0, 0, 0),
(674, '2015-11-06', 2, 0, 0, 0, 0),
(675, '2015-11-07', 1, 0, 0, 0, 0),
(676, '2015-11-07', 2, 0, 0, 0, 0),
(677, '2015-11-08', 1, 0, 0, 0, 0),
(678, '2015-11-08', 2, 0, 0, 0, 0),
(679, '2015-11-09', 1, 0, 0, 0, 0),
(680, '2015-11-09', 2, 0, 0, 0, 0),
(681, '2015-11-10', 1, 0, 0, 0, 0),
(682, '2015-11-10', 2, 0, 0, 0, 0),
(683, '2015-11-11', 1, 0, 0, 0, 0),
(684, '2015-11-11', 2, 0, 0, 0, 0),
(685, '2015-11-12', 1, 1, 0, 0, 0),
(686, '2015-11-12', 2, 0, 0, 0, 0),
(687, '2015-11-13', 1, 0, 0, 0, 0),
(688, '2015-11-13', 2, 0, 0, 0, 0),
(689, '2015-11-14', 2, 0, 0, 0, 0),
(690, '2015-11-14', 1, 0, 0, 0, 0),
(691, '2015-11-15', 2, 0, 0, 0, 0),
(692, '2015-11-15', 1, 0, 0, 0, 0),
(693, '2015-11-16', 2, 0, 0, 0, 0),
(694, '2015-11-16', 1, 0, 0, 0, 0),
(695, '2015-11-17', 2, 0, 0, 0, 0),
(696, '2015-11-17', 1, 0, 0, 0, 0),
(697, '2015-11-18', 2, 0, 0, 0, 0),
(698, '2015-11-18', 1, 0, 0, 0, 0),
(699, '2015-11-19', 2, 0, 0, 0, 0),
(700, '2015-11-19', 1, 0, 0, 0, 0),
(701, '2015-11-20', 2, 0, 0, 0, 0),
(702, '2015-11-20', 1, 0, 0, 0, 0),
(703, '2015-11-21', 2, 0, 0, 0, 0),
(704, '2015-11-21', 1, 0, 0, 0, 0),
(705, '2015-11-22', 2, 0, 0, 0, 0),
(706, '2015-11-22', 1, 0, 0, 0, 0),
(707, '2015-11-23', 2, 0, 0, 0, 0),
(708, '2015-11-23', 1, 0, 0, 0, 0),
(709, '2015-11-24', 2, 0, 0, 0, 0),
(710, '2015-11-24', 1, 0, 0, 0, 0),
(711, '2015-11-25', 2, 0, 0, 0, 0),
(712, '2015-11-25', 1, 0, 0, 0, 0),
(713, '2015-11-26', 2, 0, 0, 0, 0),
(714, '2015-11-26', 1, 0, 0, 0, 0),
(715, '2015-11-27', 2, 0, 0, 0, 0),
(716, '2015-11-27', 1, 0, 0, 0, 0),
(717, '2015-11-28', 2, 0, 0, 0, 0),
(718, '2015-11-28', 1, 0, 0, 0, 0),
(719, '2015-11-29', 2, 0, 0, 0, 0),
(720, '2015-11-29', 1, 0, 0, 0, 0),
(721, '2015-11-30', 2, 0, 0, 0, 0),
(722, '2015-11-30', 1, 0, 0, 0, 0),
(723, '2015-12-01', 2, 0, 0, 0, 0),
(724, '2015-12-01', 1, 0, 0, 0, 0),
(725, '2015-12-02', 2, 0, 0, 0, 0),
(726, '2015-12-02', 1, 0, 0, 0, 0),
(727, '2015-12-03', 2, 0, 0, 0, 0),
(728, '2015-12-03', 1, 0, 0, 0, 0),
(729, '2015-12-04', 2, 0, 0, 0, 0),
(730, '2015-12-04', 1, 0, 0, 0, 0),
(731, '2015-12-05', 2, 0, 0, 0, 0),
(732, '2015-12-05', 1, 0, 0, 0, 0),
(733, '2015-12-06', 2, 0, 0, 0, 0),
(734, '2015-12-06', 2, 0, 0, 0, 0),
(735, '2015-12-06', 1, 0, 0, 0, 0),
(736, '2015-12-06', 1, 0, 0, 0, 0),
(737, '2015-12-07', 2, 0, 0, 0, 0),
(738, '2015-12-07', 2, 0, 0, 0, 0),
(739, '2015-12-07', 1, 0, 0, 0, 0),
(740, '2015-12-07', 1, 0, 0, 0, 0),
(741, '2015-12-08', 2, 0, 0, 0, 0),
(742, '2015-12-08', 2, 0, 0, 0, 0),
(743, '2015-12-08', 1, 0, 0, 0, 0),
(744, '2015-12-08', 1, 0, 0, 0, 0),
(745, '2015-12-09', 2, 0, 0, 0, 0),
(746, '2015-12-09', 2, 0, 0, 0, 0),
(747, '2015-12-09', 1, 0, 0, 0, 0),
(748, '2015-12-09', 1, 0, 0, 0, 0),
(749, '2015-12-10', 2, 0, 0, 0, 0),
(750, '2015-12-10', 2, 0, 0, 0, 0),
(751, '2015-12-10', 1, 0, 0, 0, 0),
(752, '2015-12-10', 1, 0, 0, 0, 0),
(753, '2015-12-11', 2, 0, 0, 0, 0),
(754, '2015-12-11', 1, 0, 0, 0, 0),
(755, '2015-12-12', 2, 0, 0, 0, 0),
(756, '2015-12-12', 1, 0, 0, 0, 0),
(757, '2015-12-13', 2, 0, 0, 0, 0),
(758, '2015-12-13', 1, 0, 0, 0, 0),
(759, '2015-12-14', 2, 0, 0, 0, 0),
(760, '2015-12-14', 1, 0, 0, 0, 0),
(761, '2015-12-15', 2, 0, 0, 0, 0),
(762, '2015-12-15', 1, 0, 0, 0, 0),
(763, '2015-12-16', 2, 0, 0, 0, 0),
(764, '2015-12-16', 1, 0, 0, 0, 0),
(765, '2015-12-17', 2, 0, 0, 0, 0),
(766, '2015-12-17', 1, 0, 0, 0, 0),
(767, '2015-12-18', 2, 0, 0, 0, 0),
(768, '2015-12-18', 1, 0, 0, 0, 0),
(769, '2015-12-19', 2, 0, 0, 0, 0),
(770, '2015-12-19', 1, 0, 0, 0, 0),
(771, '2015-12-20', 2, 0, 0, 0, 0),
(772, '2015-12-20', 1, 0, 0, 0, 0),
(773, '2015-12-21', 2, 0, 0, 0, 0),
(774, '2015-12-21', 1, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `mac_validos`
--

CREATE TABLE IF NOT EXISTS `mac_validos` (
  `id` int(11) NOT NULL,
  `descricao` varchar(255) NOT NULL,
  `mac` varchar(255) NOT NULL,
  `status_mac` int(11) NOT NULL COMMENT '0 = ativo; 1 = inativo'
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `mac_validos`
--

INSERT INTO `mac_validos` (`id`, `descricao`, `mac`, `status_mac`) VALUES
(9, 'PC-ANDRE MATOS', '00-0F-CB-B1-B0-CE', 0),
(10, 'PC-PATRICIA ', 'A4-BA-DB-06-A9-64', 0),
(13, 'PC-ALEX', '00-11-D8-AF-D4-31', 0),
(14, 'LUCAS SOARES NOGUEIRA', '5C-C9-D3-34-80-42', 0);
...
INSERT INTO `maquinario` (`id`, `matricula`, `chassi_nserie`, `fabricante`, `modelo`, `id_cor`, `tipo_consumo`, `ano`, `data_compra`, `seguro`, `data_ini_seg`, `data_fim_seg`, `valor`, `id_valor_custo`, `horimetro_inicial`, `observacao`, `id_fornecedor`, `id_empresa`, `id_responsavel`, `oculto`, `controle`, `ativo`) VALUES
(1, 'LB 16', '13352151', 'Liebherr', 'LB 16 Liebherr', 7, 'Combustivel', 2015, '2015-09-24', 0, '0000-00-00', '0000-00-00', 1200300, 75, 160, 'A LB 16 Liebherr foi concebida como máquina rotativa para grandes perfurações. Podem ser executados todos os procedimentos usuais de perfuração. Incluindo a furação Kelly, perfuração sem fim com caracol, ferramente de remoção parcial ou integral, furação ', 3, 3, 4, 0, 1, 0),
(2, 'm-0001', 'm00-1', 'new holand', 'aaa111', 3, 'Eletrico', 2015, '0525-02-25', 1, '2332-03-31', '0232-03-31', 20, 18, 20, 'asdfsdfasdf ', 3, 3, 1, 0, 1, 0),
(3, 'xxx', 'xxxxxe', 'xxxx', 'ddxxx', 1, 'Eletrico', 2015, '2015-09-08', 1, '2015-09-16', '2015-09-21', 2342.34, 27, 3, 'asdfasdf  ', 3, 3, 1, 0, 1, 0),
(4, 'c-002', '65461651651', 'New Holand', 'Colheitadeira-F18', 6, 'Eletrico', 2015, '2015-09-29', 1, '2015-09-29', '2015-09-29', 546.46, 30, 65465456, 'TESTE', 3, 3, 1, 0, 1, 0),
(14, 'teste2', 'teste', 'teste', 'teste', 3, 'Eletrico', 2012, '2015-10-14', 0, '0000-00-00', '0000-00-00', 2342.34, 80, 45, 'adfsdfadsfasdf      ', 3, 3, 1, 0, 1, 0);
...
INSERT INTO `materiais` (`id`, `nome`, `id_unidade_medida`, `id_empresa`, `oculto`) VALUES
(54, 'Areia', 8, 3, 0),
(55, 'Pedra', 8, 3, 0),
(56, 'Madeira', 2, 3, 0),
(57, 'Ferro', 2, 3, 0),
...
INSERT INTO `obs_supervisor` (`id`, `id_supervisor`, `observacao`) VALUES
(13, 0, 'teste'),
(14, 0, 'Esquecimento\r\n'),
(15, 1, 'Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Teste de justificativa Te'),
(16, 0, 'teste'),
(17, 0, 'teste'),
(18, 0, 'teste');
...
INSERT INTO `patrimonio_geral` (`id`, `id_empresa`, `nome`, `matricula`, `quantidade`, `valor`, `id_valor_custo`, `descricao`, `marca`, `oculto`, `controle`) VALUES
(1, 3, 'Martelo', 'M001', 50, 25.5, 73, 'Martelo pequeno', 'Solido', 0, 0),
(2, 3, 'Martelo', 'PG001', 30, 35, 69, 'Martelo pequeno', 'Tollmix', 0, 0),
(3, 3, 'Marreta', 'pg-002', 35, 43, 72, 'Marreta pequena', 'Solido', 0, 0);
...
INSERT INTO `periodicidade` (`id`, `periodo`) VALUES
(1, 15),
(2, 30),
(3, 60),
(4, 90);
...
INSERT INTO `produtos` (`id`, `nome`, `id_empresa`, `tempo_estimado_conclusao`, `altura`, `largura`, `comprimento`) VALUES
(13, 'Parede', 3, 0.5, 1, 0.2, 1),
(14, 'Estaca 0,30 x 0,50', 5, 0, 0, 0, 0),
(15, 'Estaca 0,30 x 8,80', 5, 0, 0, 0, 0),
(16, 'Estaca 0,30 x 4,0', 5, 0, 0, 0, 0),
(17, 'Bloco 1', 5, 0, 0, 0, 0),
(18, 'Bloco 2', 5, 0, 0, 0, 0),
(19, 'Bloco 3', 5, 0, 0, 0, 0),
(21, 'fdsafdsa', 3, 0, 0, 0, 0),
(23, 'Estaca 1', 3, 3, 5, 0.5, 0.5);

-- --------------------------------------------------------

--
-- Estrutura da tabela `produto_materiais`
--
...
INSERT INTO `produto_materiais` (`id`, `id_produto`, `id_material`, `quantidade`) VALUES
(110, 14, '16:m', 50),
(111, 14, '17:m', 5),
(112, 14, '33:m', 15),
(113, 14, '18:m', 1),
...
--
-- Estrutura da tabela `regiao_trabalho`
--

CREATE TABLE IF NOT EXISTS `regiao_trabalho` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `regiao_trabalho`
--

INSERT INTO `regiao_trabalho` (`id`, `codigo`, `nome`, `id_estado`, `id_cidade`, `bairro_zona`, `descricao`, `id_empresa`, `oculto`) VALUES
(1, 'r-01', 'Regiao Sul', 18, 0, 'Sul do parana', 'Atendemos toda região Sul do parana', 3, 0),
(2, 'r-02', 'Praias', 24, 0, '', 'Atende toda região de santa catarina', 3, 0),
(3, '0151-32', 'Parana', 18, 0, '', '', 3, 0),
(4, 'R-003', 'Minas Gerais', 11, 2024, 'Toda área onde aconteceu a avalanche de barro', '', 3, 0),
(5, 'R-004', 'Brasil', 0, 0, 'Parte Sul do brasil', 'exceto Santa Catarina. ', 3, 0),
(6, 'R-005', 'brasil-02', 0, 0, 'sul do brasil', 'Toda região sul do brasil Exceto Mariana', 3, 0),
(7, 'asdfadsf', 'Lucas', 0, 0, 'adsfasdf', 'c\\zcx\\zczcx', 3, 0);
...
--
-- Extraindo dados da tabela `solicitacoes_acesso`
--

INSERT INTO `solicitacoes_acesso` (`id`, `mac`, `nome`, `telefone`, `descricao`, `empresa`, `permitido`) VALUES
(5, '00-0F-CB-B1-B0-CE', 'Andre Matos PC', '(15) 3531-2992', 'Preciso de acesso ao sistema a partir deste computador', 'Control System', 1),
(6, '40-E2-30-95-17-17', 'Computador Pessoal', '(41) 3531-2999', 'Testando solicitação de acesso', 'ControlSystem', 1),
(7, '05-06-45-48-95', 'Meu computador', '41 3531-1564', 'Preciso de acesso', 'Laboram/ R5', 1),
(10, '5C-C9-D3-34-80-42', 'Lucas Soares Nogueira', '546545', '5C-C9-D3-34-80-42 ', 'Control System', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `tipo_custo`
--
...
--
-- Extraindo dados da tabela `tipo_custo`
--

INSERT INTO `tipo_custo` (`id`, `tipo`) VALUES
(1, 'Hora'),
(2, 'Mensal'),
(3, 'Semanal'),
(4, 'Anual'),
...
INSERT INTO `token` (`id`, `token`, `data`, `invalido`) VALUES
(10, '5a54ef8c9510749498f18d9d18cadd21', '2015-10-23 08:29:14', 1),
(11, '5a54ef8c9510749498f18d9d18cadd21', '2015-10-23 08:32:01', 1),
(12, '5a54ef8c9510749498f18d9d18cadd21', '2015-10-23 09:11:05', 1),
(13, 'b08f859993c48c57e34583aa3aa6f2a9', '2015-10-26 04:46:11', 0),
(14, 'b08f859993c48c57e34583aa3aa6f2a9', '2015-10-26 04:49:59', 0),
(15, 'b08f859993c48c57e34583aa3aa6f2a9', '2015-10-26 04:51:53', 0),
(16, 'b08f859993c48c57e34583aa3aa6f2a9', '2015-10-26 05:05:58', 0);
...
INSERT INTO `tokens` (`id`, `token`, `id_mac`, `status_token`) VALUES
(106, '813cd48615f371fb35cd246dba90fcc3', 0, 1),
(107, '7abbf8efd80145cb4183f364e5cb92ae', 0, 1),
(108, 'faaa33ce4a9aa6827db1e9d521cf652b', 0, 1),
(109, '9741947f343c62cf4e5f846beb897ead', 0, 1),
(110, 'f0c8e30247b8fcb82ed75b211bcfd332', 0, 1),
(111, 'ae457ad8673b9345c5167a261edc9cd9', 0, 1),
(112, '4f3909f2c9a6e56aaa0c4521d8ed1566', 0, 1),
(113, '664eeb1852998b93b8344709b798b6f2', 0, 1),
(114, 'f90cb0f6ead5c02168a4f91865cb2c27', 0, 1),
(115, 'e8640a302cd8a46f5ad2d15ce1ff953c', 0, 1),
(116, '5b521521538cf7ddb551ebd10d77fd1a', 0, 1),
(117, '23c9d552e37576769d7075666d46e56b', 0, 1),
(118, '2654d16b4991aa2119e3894cd5d3e1df', 0, 1),
(119, 'f59d3f66e5007840ec78a772bf3e4cfe', 0, 1),
(120, '4e12b2471d500aa6c24476035ae48f34', 0, 1),
(121, 'e94d5353bef437168d40ea2c1451ecb0', 0, 1),
(122, '3f45b1e2c43d6a6278bbc1d90fa84b81', 0, 1),
(123, '802491352be8431fff502db4ea381844', 0, 1),
(124, 'a15c0b4958de32f1207c56ee29eeeaca', 0, 1),
(125, 'b03893eafb9c954eaaf9b5ad45c6d454', 0, 1),
(126, '630dc09235260dcad0239876ad8ba48e', 0, 1),
(127, '3f36fb299056cbdd78c4fc179e265ba5', 0, 1),
(128, '391fd1ca2381e2c693f5257cc2a70d1f', 0, 1),
(129, '154a68fd08df0e5ec7e920894c28d7ba', 0, 1),
(130, '79c94d8345cc44b955f6baf54b6da714', 0, 1),
(131, '636e581e81e28c0763a067df0f35f583', 0, 1),
(132, '9f945cd237252ba0319f124e4ff08683', 0, 1),
(133, 'adf10ec63fc4e593ed5d13e026f26c53', 0, 1),
(134, '20e6d66be836e6c0035021e10145e3b1', 0, 1),
(135, '6bafdfbac155154daaca0adcb17d17af', 0, 1),
(136, '0b9ee0aab4a07f4b062182214a82758c', 0, 1),
(137, 'b66330ae1cf9a807737869ad4b03c07d', 0, 1),
(138, 'a2ae34b4a54b37bdb40e8f4202a6f9b5', 0, 1),
(139, '61f19b6c0f25c017ad7341529adb021c', 0, 1),
(140, 'aef42005415b37e1f3d1ce7d84f55004', 0, 1),
(141, '0b37f08d2bb5417cf8643445b8c2ad40', 0, 1),
(142, 'e541d601a8276a7b4f58b208ffb92055', 0, 1),
(143, '7af1e0448cc089324d6bb22406d2fe13', 0, 1),
(144, '36672544c10175f9a74754aebe7426e0', 0, 1),
(145, '47a0f9425bfbd9a5bbfc34bef9ac52b8', 0, 1),
(146, 'b9886b01e5bd0aa10a2185e5c31e8aca', 0, 1),
(147, '9d814ff19db29b7bd1ccf8b825431ffc', 0, 1),
(148, 'd89626a11734e24c1c91b76f76ebf19d', 0, 1),
(149, '4968f51a20e114f579351d9b6a55135c', 0, 1),
(150, '253249de09c228b1b4341b0558cf97f4', 0, 1),
(151, '210b6d292a16a776f758d0d0251776c1', 0, 1),
(152, '55734e440b073c2b40a9db7a0ce6e4e3', 0, 1),
(153, '10d1038945b54563b69655a0df03af7e', 0, 1),
(154, '69c87017a5608251a7b112a2e08b61df', 0, 1),
(155, 'd39d69764aa4245d78507694d9ddd007', 0, 1),
(156, '4d29002d8249bd6c5b1c1cda247276cc', 0, 1);
...
CREATE TABLE IF NOT EXISTS `turno` (
  ...
  `oculto` int(11) NOT NULL,
  `id_empresa` int(11) NOT NULL,
  `sem_hor_almoco` int(11) NOT NULL
...
INSERT INTO `turno` (`id`, `nome`, `descricao`, `ini_exp`, `ini_alm`, `fim_alm`, `fim_exp`, `oculto`, `id_empresa`, `sem_hor_almoco`) VALUES
(14, 'Diurno', 'Das 08:30 às 12:00 e das 13:30 às 18:00', '08:30:00', '12:00:00', '13:30:00', '18:00:00', 0, 5, 0),
(13, 'Turno 1', 'Das 08:00 às 12:00 e das 13:00 às 18:00', '08:00:00', '12:00:00', '13:00:00', '18:00:00', 0, 3, 0),
(12, 'Turno 1', 'Das 08:00 às 13:00 e das 14:00 às 18:00', '08:00:00', '13:00:00', '14:00:00', '18:00:00', 0, 2, 0),
(11, 'Turno 1', 'Das 08:00 às 12:00 e das 13:00 às 18:00', '08:00:00', '12:00:00', '13:00:00', '18:00:00', 0, 1, 0),
(15, 'Turno 1', 'Das 08:00 às 11:00 e das 13:00 às 18:00', '08:00:00', '11:00:00', '13:00:00', '18:00:00', 0, 7, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `turno_func_historico`
--
...
INSERT INTO `unidade_medida` (`id`, `nome`, `grandeza`, `sigla`, `oculto`) VALUES
(1, 'Quilograma', 'Massa', 'Kg', 0),
(2, 'Metro', 'Comprimento', 'm', 0),
(3, 'Segundo', 'Tempo', 's', 1),
(4, 'Ampére', 'Corrente elétrica', 'A', 1),
(5, 'Metro Quadrado', 'Área', 'm²', 1),
(6, 'Joule', 'Energia', 'j', 0),
(7, 'Volt', 'Tensão elétrica', 'V', 0),
(8, 'Metro Cúbico', 'Volume', 'm³', 1),
(9, 'Watt', 'Potência', 'W', 0),
(10, 'Quantidade', 'Unidade', 'Uni', 0),
(11, 'Litro', 'Unidade de capacidade', 'L', 0),
(29, 'Energia', 'Kilowates', 'Kw', 1);

-- --------------------------------------------------------

--
-- Estrutura da tabela `valor_custo`
--

CREATE TABLE IF NOT EXISTS `valor_custo` (
  `id` int(11) NOT NULL,
  `valor` double NOT NULL,
...
--
-- Extraindo dados da tabela `valor_custo`
--

INSERT INTO `valor_custo` (`id`, `valor`, `id_tipo_custo`, `oculto`) VALUES
(1, 30, 1, 0),
(2, 30, 1, 0),
(3, 20, 1, 0),
(4, 20, 1, 0),
...
INSERT INTO `veiculo` (`id`, `matricula`, `chassi`, `renavam`, `placa`, `id_marca`, `modelo`, `ano`, `id_cor`, `valor`, `id_valor_custo`, `data_compra`, `data_ini_seg`, `data_fim_seg`, `seguro`, `km_inicial`, `tipo_combustivel`, `id_empresa`, `id_fornecedor`, `id_responsavel`, `oculto`, `ativo`, `controle`) VALUES
(1, '132132135', '31351531', 131351, '3513513', 8, '1231351', 2014, 1, 150000, 0, '2015-09-01', '0000-00-00', '0000-00-00', 0, 0, 'Gasolina', 4, 1, 2, 0, 0, 2),
(2, '12312', '132123123132', 31321321, 'aaa-1234', 7, '1321321321', 2015, 5, 1231.51, 0, '2015-09-02', '2015-09-09', '0000-00-00', 1, 123123, 'Gasolina', 4, 1, 2, 0, 0, 2),
(4, 'c-001', '4654654654', 5464654, 'aaa-5555', 12, 'Piccanto', 2015, 1, 25000, 0, '2015-09-02', '2015-09-29', '2015-09-29', 1, 250, 'Flex', 3, 3, 1, 0, 0, 2),
(6, 'carro', 'CARRO', 55555, 'CARRO', 1, 'CARRO', 2015, 1, 5000, 67, '2015-10-07', '0000-00-00', '0000-00-00', 0, 5000, 'Flex', 3, 6, 1, 0, 0, 2),
(7, 'veiculo2', 'veiculo2', 0, 'veiculo', 1, 'veiculo2', 2015, 1, 1010, 64, '2015-10-08', '2015-10-14', '2015-10-21', 1, 2000200, 'Gasolina', 3, 6, 8, 0, 0, 2);
...
--
-- Indexes for table `custo_regiao`
--
ALTER TABLE `custo_regiao`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `horarios_registrados`
--
ALTER TABLE `horarios_registrados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_IDFUNCIONARIO` (`id_funcionario`);

--
-- Indexes for table `mac_validos`
--
ALTER TABLE `mac_validos`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `produto_materiais`
--
ALTER TABLE `produto_materiais`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `regiao_trabalho`
--
ALTER TABLE `regiao_trabalho`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `codigo` (`codigo`);

--
-- Indexes for table `solicitacoes_acesso`
--
ALTER TABLE `solicitacoes_acesso`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tipo_custo`
--
...
--
-- Indexes for table `valor_custo`
--
ALTER TABLE `valor_custo`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `custo_regiao`
--
ALTER TABLE `custo_regiao`
...
--
ALTER TABLE `funcionario`
  MODIFY `id_tabela` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=91;
--
...
ALTER TABLE `horarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `horarios_registrados`
--
ALTER TABLE `horarios_registrados`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=775;
--
-- AUTO_INCREMENT for table `mac_validos`
--
ALTER TABLE `mac_validos`
...
--
-- AUTO_INCREMENT for table `regiao_trabalho`
--
ALTER TABLE `regiao_trabalho`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `solicitacoes_acesso`
--
ALTER TABLE `solicitacoes_acesso`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tipo_custo`
--
ALTER TABLE `tipo_custo`
...
ALTER TABLE `unidade_medida`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `valor_custo`
--
ALTER TABLE `valor_custo`
